...
public class LeftAutoCommand extends SequentialCommandGroup {
  ...
  public LeftAutoCommand(ShootSystem shootSystem, CollectionSystem collectionSystem,DriveSystem driveSystem,Limelight limelight ,CartridgeSystem cartridgeSystem, KickerSystem kickerSystem, PitchSystem pitchSystem) {
